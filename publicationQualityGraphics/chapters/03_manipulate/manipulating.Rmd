...
opts_chunk$set(prompt=FALSE, comment='', results='markup', fig.path = '../../book_figures/', fig.align = 'center', tidy = FALSE)
...
```{r grid manipulate, fig.width = 10, fig.height = 7, fig.cap = fn("using the grid package to add a color key to an existing lattice plot object"), fig.align = 'center'}
